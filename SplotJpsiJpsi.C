...
void AddModel(RooWorkspace* ws){
  ...
  //TFile* f = new TFile ("./Input_To_Fit_pT_Sort_iter_7_2012_Data.root","READ");
  ...
  RooRealVar*  jpsi1_mass_1 = new RooRealVar("jpsi1_mass_1","",3.09300e+00);
  RooRealVar*  jpsi1_mass_2 = new RooRealVar("jpsi1_mass_2","",3.09553e+00);
  RooRealVar*  jpsi1_width_1 = new RooRealVar("jpsi1_width_1","",4.62952e-02);
  RooRealVar*  jpsi1_width_2 = new RooRealVar("jpsi1_width_2","",4.56886e-01);
  RooFormulaVar*  jpsi1_width_a = new RooFormulaVar("jpsi1_width_a","","@0*@1",RooArgList(*jpsi1_width_1,*jpsi1_width_2));
  RooRealVar*  frac_1 = new RooRealVar("frac_1","",5.47353e-01);

  RooRealVar*  jpsi2_mass_1 = new RooRealVar("jpsi2_mass_1","",3.08938e+00);
  RooRealVar*  jpsi2_mass_2 = new RooRealVar("jpsi2_mass_2","",3.09285e+00);
  RooRealVar*  jpsi2_width_1 = new RooRealVar("jpsi2_width_1","",5.69357e-02);
  RooRealVar*  jpsi2_width_2 = new RooRealVar("jpsi2_width_2","",5.82996e-01);
  RooFormulaVar*  jpsi2_width_a = new RooFormulaVar("jpsi2_width_a","","@0*@1",RooArgList(*jpsi2_width_1,*jpsi2_width_2));
  RooRealVar*  frac_2 = new RooRealVar("frac_2","",3.62924e-01);  

  RooRealVar*  R_mean_coreCT1 = new RooRealVar("R_mean_coreCT1","",2.63860e-05);
  //RooRealVar*  R_mean_coreCT1 = new RooRealVar("R_mean_coreCT1","",0.,-0.1,0.1);
  ...
  //RooRealVar*  R_sigma_coreCT1 = new RooRealVar("R_sigma_coreCT1","",0.01,0.,0.1);
  ...
  RooRealVar*   Bbkg_jpsi1_mass_1 = new RooRealVar("Bbkg_jpsi1_mass_1","",3.09313e+00);
  RooRealVar*   Bbkg_jpsi1_mass_2 = new RooRealVar("Bbkg_jpsi1_mass_2","",3.09553e+00);
  RooRealVar*   Bbkg_jpsi1_width_1 = new RooRealVar("Bbkg_jpsi1_width_1","",5.79266e-02);
  RooRealVar*   Bbkg_jpsi1_width_2 = new RooRealVar("Bbkg_jpsi1_width_2","",4.56886e-01);
  ...
  RooRealVar*   Bbkg_frac_1 = new RooRealVar("Bbkg_frac_1","",1.80473e-01);

  RooRealVar*   Bbkg_jpsi2_mass_1 = new RooRealVar("Bbkg_jpsi2_mass_1","",3.08933e+00);
  RooRealVar*   Bbkg_jpsi2_mass_2 = new RooRealVar("Bbkg_jpsi2_mass_2","",3.09285e+00);
  RooRealVar*   Bbkg_jpsi2_width_1 = new RooRealVar("Bbkg_jpsi2_width_1","",5.06183e-02);
  RooRealVar*   Bbkg_jpsi2_width_2 = new RooRealVar("Bbkg_jpsi2_width_2","",5.82996e-01);
  ...
  RooRealVar*   Bbkg_frac_2 = new RooRealVar("Bbkg_frac_2","",4.47328e-01);
  ...
  //RooRealVar*   Bbkg_mean_CT1 = new RooRealVar("Bbkg_mean_CT1","",2.63860e-05);
  //RooRealVar*   Bbkg_width_CT1 = new RooRealVar("Bbkg_width_CT1","",2.72201e-03);
  ...
  //RooRealVar*   Bbkg_lambda_CT1 = new RooRealVar("Bbkg_lambda_CT1","Bbkg_lambda_CT1",1.59728e-02); // for all dataset
...
// Build another gaussian resolution model
  /*RooRealVar bias1("bias1","bias1",2.63860e-05) ;
  RooRealVar sigma1("sigma1","sigma1",2.72201e-03) ;  
  RooGaussModel gm1("gm1","gauss model 1",*Psi1_CTxy,bias1,sigma1) ;
  RooRealVar bias2("bias2","bias2",1.19874e-03) ;
  RooRealVar sigma2("sigma2","sigma2",2.72258e+00) ;  
  RooGaussModel gm2("gm2","gauss model 2",*Psi1_CTxy,bias2,sigma2) ;

  // Build a composite resolution model
  RooRealVar gm1frac("gm1frac","fraction of gm1",8.47797e-01) ;
  ...
  //RooGaussModel resolution_R1("resolution_R1","",*Psi1_CTxy,*R_mean_coreCT1,*R_sigma_coreCT1);
  RooDecay Bbkg_CT1("Bbkg_CT1","",*Psi1_CTxy,*Bbkg_lambda_CT1,resolution_R1,RooDecay::SingleSided);

  // d-g model
  //RooDecay Bbkg_CT1("Bbkg_CT1","",*Psi1_CTxy,*Bbkg_lambda_CT1,gmsum,RooDecay::SingleSided);


  //RooAddModel new_ct_1("new_ct_1","ct distribution",RooArgList(ct_1a,ct_1b),RooArgList(*R_fracCT1));
  //RooDecay Bbkg_CT1("Bbkg_CT1","",*Psi1_CTxy,*Bbkg_lambda_CT1,new_ct_1,RooDecay::SingleSided);
  ...
  // jpsi-sideband case
  RooRealVar*    bkg_jpsi1_mass_1 = new RooRealVar("bkg_jpsi1_mass_1","",3.09313e+00);
  //RooRealVar*    bkg_jpsi1_mass_2 = new RooRealVar("bkg_jpsi1_mass_2","",3.09313e+00);
  RooRealVar*    bkg_jpsi1_width_1 = new RooRealVar("bkg_jpsi1_width_1","",5.79266e-02);
  RooRealVar*    bkg_jpsi1_width_2 = new RooRealVar("bkg_jpsi1_width_2","",4.56886e-01);
  ...
  // sideband-jpsi case
  RooRealVar*    bkg_jpsi2_mass_1 = new RooRealVar("bkg_jpsi2_mass_1","",3.08933e+00);
  //RooRealVar*    bkg_jpsi2_mass_2 = new RooRealVar("bkg_jpsi2_mass_2","",3.08933e+00);
  RooRealVar*    bkg_jpsi2_width_1 = new RooRealVar("bkg_jpsi2_width_1","",5.06183e-02);
  RooRealVar*    bkg_jpsi2_width_2 = new RooRealVar("bkg_jpsi2_width_2","",5.82996e-01);
  RooFormulaVar* bkg_jpsi2_width_a = new RooFormulaVar("bkg_jpsi1_width_a","","@0*@1",RooArgList(*bkg_jpsi2_width_1,*bkg_jpsi2_width_2));
  RooRealVar*    bkg_frac_7 = new RooRealVar("bkg_frac_7","",4.47328e-01);
  ...
  //RooRealVar*  bkg_frac_5 = new RooRealVar("bkg_frac_5","",6.47958e-01); // for all dataset
...
void MakePlots(RooWorkspace* ws){
  ...
  CTxy1Plot->SetTitle("");
  CTxy1Plot->SetXTitle("high-p_{T} J/#psi ct_{xy} (cm)");
  CTxy1Plot->SetYTitle("Events / 0.005 cm");
  CTxy1Plot->SetMaximum(4200);
  ...
  SigPlot->SetXTitle("Distance significance #deltad");
  SigPlot->SetMaximum(920);
  SigPlot->Draw();
